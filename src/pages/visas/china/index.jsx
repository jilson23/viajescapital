  ...
  return (
    <div className="China">
      ...
      <ul>
        ...
        <li>
          Carta Laboral o de Trabajo o Certificado de Ingresos expedido por contador
          público y fotocopia de su tarjeta profesional.
        </li>
        <li>
          Certificado de camara y comercio en original tanto para independientes como para
          empleados.
        </li>
        <li>Reserva Aérea o fotocopia de sus tiquetes aéreos (si ya los tiene).</li>
        <li>
          Reserva Hotelera o Carta de Justificación de Hospedaje en China (Nombre de
      ...
      <p>
        (Este tipo de visa también se otorga a personas que van a China con el propósito
        de realizar trabajos de corto tiempo o prácticas profesionales, como pasantías,
        seminarios, conferencias o congresos).
      </p>
      ...
      <ul>
        ...
        <li>
          Carta de Invitación expedida por una entidad oficial o una Autoridad China
          (Formato ¨Please apply forthwith for visa at the Chinese Embassy/Consulate/Visa
      ...
      <div className="grid2">
        <Notas>
          Los extranjeros residentes en Colombia pueden solicitar la visa presentando
          junto con los demás documentos requeridos, fotocopia de su cédula de extranjería
          y visa colombiana.
        </Notas>
        <Notas color="green">
          Caso Hong Kong: los colombianos que viajan a Hong Kong y su estadía va a ser
          menos de 90 días, no requieren visa.
        </Notas>
      </div>

      <p>Este Trámite demora 5 dias hábiles.</p>

      <TituloLinea titulo="Precios por persona" />
      <ul>
        <li>Valor Trámite por una entrada $ 277.000</li>
        <li>Valor Trámite por 2 entradas $ 377.000</li>
      </ul>
